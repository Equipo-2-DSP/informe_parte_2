...
se ve en la ecuacion (omega.k creo que era Xavi). Reemplazando dicha relación en la ecuacion (\ref{DTFT}) se obtiene la expresion de la DFT :
 ...
 \subsection{Obtencion de la CTFT a partir de la DFT}
 ...
 \item Utilizar la ecuacion (22).
 \end{enumerate}
Se puede obtener una estimación exacta si se eligen de manera correcta los siguientes parametros:
 \begin{enumerate}
